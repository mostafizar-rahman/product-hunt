...
const Footer = () => {
  return (
    <footer className="text-white bg-[#101f32]">
      <div className="max-w-[1370px] mx-auto px-5 pb-6 pt-16 lg:pt-24 mt-14">
            ...
            <ul className="mt-3 flex justify-center gap-6 sm:justify-start md:gap-8">
              <li>
                <Link
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-lime-500 transition hover:text-lime-500/75"
                >
        ...
        <div className="mt-12 border-t border-gray-100 pt-6">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            ...
            <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">
              &copy; 2023 <Link to={"https://mostafizar.netlify.app/"}>Mostafizar Rahman</Link>
            </p>
          </div>
        </div>
      </div>
